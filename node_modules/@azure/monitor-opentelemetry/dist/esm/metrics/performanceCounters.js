...
export class PerformanceCounterMetrics {
    ...
    constructor(config, options) {
        ...
        this.azureExporter = new AzureMonitorMetricExporter(this.internalConfig.azureMonitorExporterOptions);
        ...
        // Create Instruments
        this.requestDurationHistogram = this.meter.createHistogram(PerformanceCounterMetricNames.REQUEST_DURATION, { valueType: ValueType.DOUBLE });
        this.requestRateGauge = this.meter.createObservableGauge(PerformanceCounterMetricNames.REQUEST_RATE, {
            description: "Incoming Requests Average Execution Time",
            valueType: ValueType.DOUBLE,
        });
        this.memoryPrivateBytesGauge = this.meter.createObservableGauge(PerformanceCounterMetricNames.PRIVATE_BYTES, { description: "Amount of memory process has used in bytes", valueType: ValueType.INT });
        this.memoryAvailableBytesGauge = this.meter.createObservableGauge(PerformanceCounterMetricNames.AVAILABLE_BYTES, { description: "Amount of available memory in bytes", valueType: ValueType.INT });
        this.processorTimeGauge = this.meter.createObservableGauge(PerformanceCounterMetricNames.PROCESSOR_TIME, {
        ...
        this.processTimeNormalizedGauge = this.meter.createObservableGauge(PerformanceCounterMetricNames.PROCESS_TIME_NORMALIZED, {
            description: "Process CPU usage normalized as a percentage",
            valueType: ValueType.DOUBLE,
        });
        this.exceptionCountGauge = this.meter.createObservableGauge(PerformanceCounterMetricNames.EXCEPTION_RATE, {
