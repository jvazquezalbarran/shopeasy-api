...
function parseResourceDetectorsFromEnvVar() {
    ...
    const resourceDetectors = new Map([
        ["env", resources_1.envDetector],
        ["host", resources_1.hostDetector],
        ["os", resources_1.osDetector],
        ["process", resources_1.processDetector],
        ["serviceinstance", resources_1.serviceInstanceIdDetector],
    ]);
    if (process.env.OTEL_NODE_RESOURCE_DETECTORS != null) {
        ...
        return [resources_1.envDetector, resources_1.hostDetector, resources_1.osDetector];
    }
}
